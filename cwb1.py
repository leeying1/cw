...
# Description: Read data from RESOURCE.DAT, format and output
#              to screen
...
def DISPLAYRESOURCE():
    try:
       ...
       # display heading lines with creation date and numeber of records
       ...
       for record_line in detail_lines:
           ...
           # store resource no, title, date required and resource type
